...
/*!
 * \def EXTERN_INLINE_KALMAN Helper inline to switch from local inline to extern
 * inline
 */
 ...
 * \see kalman_predict_Q_tuned
 */
HOT EXTERN_INLINE_KALMAN void kalman_predict_tuned(kalman_t *kf,
 ...
 */
HOT PURE EXTERN_INLINE_KALMAN matrix_t *
kalman_get_state_transition(kalman_t *kf)
{
	return &(kf->F);
}
 ...
 */
HOT PURE EXTERN_INLINE_KALMAN matrix_t *
kalman_get_input_transition(kalman_t *kf)
{
	return &(kf->B);
}
 ...
 */
HOT PURE EXTERN_INLINE_KALMAN matrix_t *
kalman_get_measurement_vector(kalman_measurement_t *kfm)
{
	return &(kfm->z);
}
 ...
 */
HOT PURE EXTERN_INLINE_KALMAN matrix_t *
kalman_get_measurement_transformation(kalman_measurement_t *kfm)
{
	return &(kfm->H);
}
 ...
 */
HOT PURE EXTERN_INLINE_KALMAN matrix_t *
kalman_get_observation_noise(kalman_measurement_t *kfm)
{
	return &(kfm->R);
}
